...
public class Main {
    public static void main(String[] args) {
        task1();
        /**
         * Реализуйте метод, который получает в качестве параметра год, а затем проверяет, является ли
         ...
         *     но и год его создания: от этого зависит, подойдет ли приложение для телефона или оно просто не
         *     установится.
         ...
         *     оператора).
         * Напишите метод, куда подаются два параметра: тип операционной системы (ОС) ( 0 — iOS или
         ...
         *     доставку банковских карт на дом с четкой датой доставки. Чтобы известить клиента о том, когда
         *     будет доставлена его карта, нам нужно знать расстояние от нашего офиса до адреса доставки.
    ...
    public static void task2() {
        ...
        if (clientOS != 0 && clientOS != 1) {
            ...
            printMessage(clientOS, clientDeviceYear);
        }
    }
    ...
    public static void task3() {
        ...
        if (deliveryDistance <= 0) {
            System.out.println("Не верно введено расстояние.");
        } else {
    ...
    public static void printDeliveryDays(int number) {
        System.out.printf("Потребуется дней: %d", number);
    }
